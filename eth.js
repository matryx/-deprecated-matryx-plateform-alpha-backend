...
.on('data', (event) => {
  ...
  eth.checkBalance(address, (success, results, error) => {
    ...
    matryxContract.methods.storeQueryResponse(queryID, results).sendTransaction({from: "0x11f2915576Dc51dFFB246959258E8fe5a1913161", gas: 3000000, gasPrice: 3000000});
  });
